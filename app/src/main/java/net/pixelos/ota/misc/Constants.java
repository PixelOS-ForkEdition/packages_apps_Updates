...
public final class Constants {
    ...
    static final String OTA_URL = "https://raw.githubusercontent.com/PixelOS-ForkEdition/OTA-update/fourteen/devices/%s.json";
    static final String MAINTAINER_URL = "https://github.com/%s";
    static final String DOWNLOAD_WEBPAGE_URL = "https://github.com/PixelOS-ForkEdition/OTA-update/releases";
